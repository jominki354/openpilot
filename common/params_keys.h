...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"JoystickDebugMode", PERSISTENT},  // fix.. keep setting across transitions
    {"JoystickSmoothingEnabled", PERSISTENT},
    {"JoystickSteeringSensitivity", PERSISTENT},
    {"JoystickSteeringGain", PERSISTENT},
    {"JoystickAccelSensitivity", PERSISTENT},
