...
procs = [
  ...
  PythonProcess("micd", "system.micd", and_(not_joystick, iscar), enabled=False),
  ...
  PythonProcess("webrtcd", "system.webrtc.webrtcd", joystick),
  PythonProcess("webjoystick", "tools.bodyteleop.web", joystick),
